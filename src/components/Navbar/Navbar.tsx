    ...
    <>
      <header className="bg-blue-600 shadow-lg sticky top-0 z-50">
        <nav className="px-4 py-3 flex items-center">
          ...
          <button
            className="ml-auto flex items-center gap-2  bg-white text-red-500 px-4 py-2 rounded-md font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-red-400"
